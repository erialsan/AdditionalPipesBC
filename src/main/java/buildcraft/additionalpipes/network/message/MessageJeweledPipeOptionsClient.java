...
public class MessageJeweledPipeOptionsClient
    implements IMessage, IMessageHandler<MessageJeweledPipeOptionsClient, IMessage> {
    ...
    public IMessage onMessage(MessageJeweledPipeOptionsClient message, MessageContext ctx) {
        ...
        TileEntity te = FMLClientHandler.instance()
        ...
        if (te instanceof TileGenericPipe) {
            ...
            GuiScreen currentScreen = FMLClientHandler.instance()
