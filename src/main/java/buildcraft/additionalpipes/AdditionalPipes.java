...
@Mod(
    modid = AdditionalPipes.MODID,
    name = AdditionalPipes.NAME,
    dependencies = "after:BuildCraft|Transport[7.1.18,);after:BuildCraft|Silicon;after:BuildCraft|Transport;after:BuildCraft|Factory;after:LogisticsPipes",
...
public class AdditionalPipes {
    ...
    @SidedProxy(
        clientSide = "buildcraft.additionalpipes.MultiPlayerProxyClient",
        serverSide = "buildcraft.additionalpipes.MultiPlayerProxy")
    ...
    public void init(FMLInitializationEvent event) {
        ...
        if (APConfiguration.enableChunkloader) {
            ...
            GameRegistry.addRecipe(
                new ShapedOreRecipe(
                    ...
                    "gemLapis",
                    'c',
                    BuildCraftSilicon.redstoneChipset));

            // the lasers key function depends on the chunk loading code, so it can only be enabled if the chunk loader
            // is
        ...
        if (APConfiguration.allowWRRemove) {
            ...
            if (logisticsPipesInstalled) {
                GameRegistry
                    .addShapelessRecipe(new ItemStack(pipeItemsTeleport), new Object[] { pipeLogisticsTeleport });
            }
            ...
            GameRegistry.addShapelessRecipe(
                ...
                new Object[] { BuildCraftTransport.pipeFluidsCobblestone });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsGold),
                new Object[] { BuildCraftTransport.pipeFluidsGold });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsIron),
                new Object[] { BuildCraftTransport.pipeFluidsIron });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsStone),
                new Object[] { BuildCraftTransport.pipeFluidsStone });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsWood),
                new Object[] { BuildCraftTransport.pipeFluidsWood });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsDiamond),
                new Object[] { BuildCraftTransport.pipeFluidsDiamond });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsEmerald),
                new Object[] { BuildCraftTransport.pipeFluidsEmerald });

            // BC Power
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsGold),
                new Object[] { BuildCraftTransport.pipePowerGold });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsStone),
                new Object[] { BuildCraftTransport.pipePowerStone });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsWood),
                new Object[] { BuildCraftTransport.pipePowerWood });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsCobblestone),
                new Object[] { BuildCraftTransport.pipePowerCobblestone });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsEmerald),
                new Object[] { BuildCraftTransport.pipePowerEmerald });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsDiamond),
                new Object[] { BuildCraftTransport.pipePowerDiamond });
            GameRegistry.addShapelessRecipe(
                new ItemStack(BuildCraftTransport.pipeItemsQuartz),
                new Object[] { BuildCraftTransport.pipePowerQuartz });
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        if (logisticsPipesInstalled) {
            ...
            try {
                ...
                Class<?> SpecialPipeConnection = Class
                    .forName("logisticspipes.proxy.specialconnection.SpecialPipeConnection");
                Class<?> ISpecialPipedConnection = Class
                    .forName("logisticspipes.interfaces.routing.ISpecialPipedConnection");
                Class<?> APSpecialPipedConnection = Class
                    .forName("buildcraft.additionalpipes.pipes.APSpecialPipedConnection");
                ...
                Method registerHandler = SpecialPipeConnection
                    .getDeclaredMethod("registerHandler", ISpecialPipedConnection);
    ...
    private void loadPipes() {
        // Item Teleport Pipe
        pipeItemsTeleport = PipeCreator
            .createPipeTooltip((Class<? extends APPipe<?>>) PipeItemsTeleport.class, "tip.teleportPipe");

        AssemblyRecipeManager.INSTANCE.addRecipe(
            "teleportPipe",
            10000,
            new ItemStack(pipeItemsTeleport, 8),
            new Object[] { new ItemStack(BuildCraftSilicon.redstoneChipset, 1, 4),
        ...
        pipeLiquidsTeleport = PipeCreator
            .createPipeTooltip((Class<? extends APPipe<?>>) PipeLiquidsTeleport.class, "tip.teleportPipe");
        if (pipeItemsTeleport != null) {
            GameRegistry.addShapelessRecipe(
                new ItemStack(pipeLiquidsTeleport),
                new Object[] { BuildCraftTransport.pipeWaterproof, pipeItemsTeleport });
        }

        // Power Teleport Pipe

        pipePowerTeleport = PipeCreator
            .createPipeTooltip((Class<? extends APPipe<?>>) PipePowerTeleport.class, "tip.teleportPipe");
        if (pipeItemsTeleport != null) {
            GameRegistry.addShapelessRecipe(
                new ItemStack(pipePowerTeleport),
                new Object[] { Items.redstone, pipeItemsTeleport });
        }

        if (logisticsPipesInstalled) {
            // Logistics Teleport Pipe
            pipeLogisticsTeleport = PipeCreator.createPipeTooltip(
                (Class<? extends APPipe<?>>) PipeLogisticsTeleport.class,
                "tip.teleportLogisticsPipe");
            if (pipeItemsTeleport != null) {
                GameRegistry.addShapelessRecipe(
                    new ItemStack(pipeLogisticsTeleport),
                    new Object[] { pipeItemsTeleport, BuildCraftSilicon.redstoneChipset });
            }
        }

        // Jeweled Pipe
        pipeItemsJeweled = PipeCreator.createPipeAndRecipe(
            2,
            PipeItemsJeweled.class,
            false,
            " D ",
            "DGD",
            " D ",
        ...
        // Distributor Pipe
        pipeItemsDistributor = PipeCreator.createPipeAndRecipe(
            1,
            PipeItemsDistributor.class,
            false,
            " r ",
            "IgI",
            'r',
        ...
        pipeItemsAdvancedInsertion = PipeCreator
            .createPipeAndRecipe(8, PipeItemsAdvancedInsertion.class, false, "IgI", 'I', "gearIron", 'g', "blockGlass");

        // Advanced Insertion Pipe
        pipeItemsAddition = PipeCreator.createPipeAndRecipe(
            1,
            PipeItemsAddition.class,
            false,
            " R ",
            "RIR",
            " R ",
            'I',
            pipeItemsAdvancedInsertion,
            'R',
            "dustRedstone");

        pipeItemsPriority = PipeCreator.createPipeAndRecipe(
            2,
            PipeItemsPriorityInsertion.class,
            true,
            pipeItemsDistributor,
            pipeItemsAdvancedInsertion);

        // Advanced Wooden Pipe
        pipeItemsAdvancedWood = PipeCreator
            .createPipeAndRecipe(8, PipeItemsAdvancedWood.class, false, "WgW", 'W', "gearWood", 'g', "blockGlass");

        // Gravity Feed Pipe
        pipeItemsGravityFeed = PipeCreator.createPipeAndRecipe(
            1,
            PipeItemsGravityFeed.class,
            false,
            "   ",
            "IgI",
            " I ",
        ...
        // Closed Items Pipe
        pipeItemsClosed = PipeCreator
            .createPipeAndRecipe(1, PipeItemsClosed.class, true, BuildCraftTransport.pipeItemsVoid, "gearIron");

        // switch pipes
        pipeItemsSwitch = PipeCreator.createPipeAndRecipe(
            8,
            PipeSwitchItems.class,
            false,
            "GgI",
            'g',
            "blockGlass",
        ...
        int switchPowerCapacity = (PipeTransportPower.powerCapacities.get(PipePowerGold.class)
            + PipeTransportPower.powerCapacities.get(PipePowerIron.class)) / 2;

        PipeTransportPower.powerCapacities.put(PipeSwitchPower.class, switchPowerCapacity);
        pipePowerSwitch = PipeCreator
            .createPipeAndRecipe(1, PipeSwitchPower.class, true, pipeItemsSwitch, "dustRedstone");
        ...
        pipeLiquidsSwitch = PipeCreator
            .createPipeAndRecipe(1, PipeSwitchFluids.class, true, pipeItemsSwitch, BuildCraftTransport.pipeWaterproof);

        // water pump pipe
        // set fluid capacity
        PipeTransportFluids.fluidCapacities.put(PipeLiquidsWaterPump.class, APConfiguration.waterPumpWaterPerTick);
        pipeLiquidsWaterPump = PipeCreator.createPipeAndRecipe(
            1,
            PipeLiquidsWaterPump.class,
            false,
            " L ",
            "rPr",
            " W ",
        ...
        pipeLiquidsObsidian = PipeCreator.createPipeAndRecipe(
            1,
            PipeLiquidsObsidian.class,
            true,
            BuildCraftTransport.pipeItemsObsidian,
            BuildCraftTransport.pipeWaterproof);
    }
