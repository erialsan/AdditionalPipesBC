...
public class ContainerJeweledPipe extends Container {
    ...
    public ContainerJeweledPipe(InventoryPlayer inventoryPlayer, PipeItemsJeweled pipe) {
            ...
            for (int filterRowIndex = 0; filterRowIndex < 3; ++filterRowIndex) {
                for (int filterColumnIndex = 0; filterColumnIndex < 9; ++filterColumnIndex) {
                    Slot newSlot = new Slot(
                        pipe.filterData[side],
                        filterColumnIndex + filterRowIndex * 9,
                        filterColumnIndex * 18,
                        1000 + ((3 * side) + filterRowIndex) * 18);
            ...
            for (int inventoryColumnIndex = 0; inventoryColumnIndex
                ...
                this.addSlotToContainer(
                    new Slot(
                        ...
                        SLOT_START_X + inventoryColumnIndex * 18,
                        128 + inventoryRowIndex * 18));
            }
        }
        ...
        for (int actionBarSlotIndex = 0; actionBarSlotIndex < PLAYER_INVENTORY_COLUMNS; ++actionBarSlotIndex) {
            this.addSlotToContainer(
                new Slot(inventoryPlayer, actionBarSlotIndex, SLOT_START_X + actionBarSlotIndex * 18, 186));
        }
        ...
        if (FMLCommonHandler.instance()
            ...
            MessageJeweledPipeOptionsClient message = new MessageJeweledPipeOptionsClient(
