...
public class GuiTeleportPipe extends GuiBuildCraft {
        ...
        public void draw(int x, int y) {
            ...
            if (net.length > 0) {
                fontRendererObj.drawString(
                    new StringBuilder("(").append(net[0])
                        .append(", ")
                        .append(net[1])
                        .append(", ")
                        .append(net[2])
            ...
            if (net.length > 3) {
                fontRendererObj.drawString(
                    new StringBuilder("(").append(net[3])
                        .append(", ")
                        .append(net[4])
                        .append(", ")
                        .append(net[5])
            ...
            if (net.length > 6) {
                fontRendererObj.drawString(
                    new StringBuilder("(").append(net[6])
                        .append(", ")
                        .append(net[7])
                        .append(", ")
                        .append(net[8])
    ...
    protected void drawGuiContainerForegroundLayer(int p1, int p2) {
        ...
        fontRendererObj.drawString(
            new StringBuilder("(").append(pipe.container.xCoord)
                .append(", ")
                .append(pipe.container.yCoord)
                .append(", ")
                .append(pipe.container.zCoord)
                .append(")")
                .toString(),
            128,
            12,
    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        MessageTelePipeUpdate packet = new MessageTelePipeUpdate(
